...
class DocumentCrawlerApp:
    ...
    def render_ui(self):
        ...
        **Instructions:**
        ...
        with col1:
            ...
            url_text = st.text_area("URLs", height=200, placeholder="https://docs.example.com\nhttps://api.another-example.com")
    ...
    async def call_crawler_api(self, urls: List[str]) -> Dict[str, Any]:
        async with aiohttp.ClientSession() as session:
            async with session.post("http://localhost:8000/", json=urls) as response:
        ...
        with self.status_container:
            ...
            try:
                ...
                with st.spinner("Crawling documents..."):
                    ...
                    self.status_text.text("Phase 2/3: Generating vector embeddings...")
                    ...
                    st.json({"vector_count": len(urls) * 10, "message": "success"})
